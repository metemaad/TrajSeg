...
def plot(df, label, xcl):
    ...
    axs[0].axvspan(xmin=-0.40, xmax=-0.07, color='g', alpha=0.2)  # swsfishing
    axs[1].axvspan(xmin=-0.40, xmax=-0.07, color='g', alpha=0.2)  # swsfishing
    ...
    plt.savefig('SWS_compare_other_h.png')
