...
list_of_params = [{
    ...
    '__algorithm__': 'SWS_RW_WS_5_rec',
    '__dataset_name__': "FishingDataset",
    '__load_data_function__': load_datasets.load_data_fishing_data_recons,
    '__plotting__': False,
    '__seed__': 110,
    '__verbose__': False,
    '__tuning_parameters__': {
        'sws_params': {'window_size_param': [5], 'interpolation_kernel_param':
            ['Random Walk'], 'epsilon_param': [None]}}}
    ,
    {
        '__datafile__': '~/Trajlib2/Trajlib2/databases/Hurricanes',
        '__algorithm__': 'SWS_RW_WS_5',
        ...
        '__verbose__': False,
        '__tuning_parameters__': {
            'sws_params': {'window_size_param': [5], 'interpolation_kernel_param': ['Random Walk'], 'epsilon_param': [None]}}},
    {
